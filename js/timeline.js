...
class Timeline
{
    ...
    HMS_test()
    {
        // this.name = "High Midgardsormr"
        this.name = {
            'en-us': "High Midgardsormr",
            'zh-cn': "真耶梦加得",
        }
        this.mainColor = "#61FF33";
        ...
        this.addActionInvMSec('init', 4, 46, 'tristorm');
        this.addActionInvMSec('init', 4, 40, 'dash');
        this.addActionInvMSec('init', 4, 34, 'jump');
        this.addActionInvMSec('init', 4, 30, 'spotwind');
        this.addActionInvMSec('init', 4, 23, 'bigstorm');
        this.addActionInvMSec('init', 4, 18, 'spotred');
        this.addActionInvMSec('init', 4, 12, 'spotpurp');
        this.addActionInvMSec('init', 4, 07, 'dash');
        this.addActionInvMSec('init', 4, 01, 'spotwind');
        this.addActionInvMSec('init', 3, 51, 'jump');
        this.addActionInvMSec('init', 3, 47, 'tristorm');
        this.addActionInvMSec('init', 3, 42, 'dash');
        this.addActionInvMSec('init', 3, 36, 'spotwind');
        this.addActionInvMSec('init', 3, 29, 'bigstorm');
        this.addActionInvMSec('init', 3, 21, 'dash');
        this.addActionInvMSec('init', 3, 15, 'mobs');
        this.addActionInvMSec('init', 3, 13, 'spotwind');
        this.addActionInvMSec('init', 3, 07, 'dash');
        this.addActionInvMSec('init', 2, 57, 'jump');
        this.addActionInvMSec('init', 2, 53, 'tristorm');
        this.addActionInvMSec('init', 2, 48, 'dash');
        this.addActionInvMSec('init', 2, 42, 'bigstorm');
        this.addActionInvMSec('init', 2, 37, 'spotwind');
        this.addActionInvMSec('init', 2, 26, 'jump');
        this.addActionInvMSec('init', 2, 23, 'fourwind');
        this.addActionInvMSec('init', 2, 10, 'dash');
        this.addActionInvMSec('init', 2,  0, 'jump');
        this.addActionInvMSec('init', 1, 56, 'spotwind');
        this.addActionInvMSec('init', 1, 50, 'bigstorm');
